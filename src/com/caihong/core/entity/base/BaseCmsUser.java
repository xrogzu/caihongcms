...
public abstract class BaseCmsUser  implements Serializable {
	...
	private java.util.Set<com.caihong.core.entity.CmsUserExt> userExtSet;
	private java.util.Set<com.caihong.core.entity.CmsUserAccount> userAccountSet;
	private java.util.Set<com.caihong.core.entity.CmsUserSite> userSites;
	private java.util.Set<com.caihong.core.entity.CmsRole> roles;
	private java.util.Set<com.caihong.cms.entity.main.Channel> channels;
	private java.util.Set<com.caihong.cms.entity.main.Content> collectContents;
	private java.util.Set<com.caihong.cms.entity.main.ContentBuy> buyContentSet;
	
	private java.util.Set<com.caihong.cms.entity.assist.CmsMessage> sendMessages;
	private java.util.Set<com.caihong.cms.entity.assist.CmsMessage> receivMessages;
	private java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages;
	private java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages;
	
	private java.util.Set<com.caihong.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.caihong.core.entity.CmsUserResume> userResumeSet;
	private java.util.Set<CmsLog> logs;
	private java.util.Set<com.caihong.cms.entity.assist.CmsUserMenu> menus;
	private java.util.Set<com.caihong.core.entity.CmsWorkflowEventUser> eventUsers;
	 ...
	 */
	public com.caihong.core.entity.CmsGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.caihong.core.entity.CmsGroup group) {
		this.group = group;
	}

	public com.caihong.core.entity.CmsDepartment getDepartment() {
		return department;
	}

	public void setDepartment(com.caihong.core.entity.CmsDepartment department) {
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsUserExt> getUserExtSet () {
		return userExtSet;
	}
	 ...
	 */
	public void setUserExtSet (java.util.Set<com.caihong.core.entity.CmsUserExt> userExtSet) {
		this.userExtSet = userExtSet;
	}
	
	public java.util.Set<com.caihong.core.entity.CmsUserAccount> getUserAccountSet() {
		return userAccountSet;
	}

	public void setUserAccountSet(java.util.Set<com.caihong.core.entity.CmsUserAccount> userAccountSet) {
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsUserSite> getUserSites () {
		return userSites;
	}
	 ...
	 */
	public void setUserSites (java.util.Set<com.caihong.core.entity.CmsUserSite> userSites) {
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsRole> getRoles () {
		return roles;
	}
	 ...
	 */
	public void setRoles (java.util.Set<com.caihong.core.entity.CmsRole> roles) {
		this.roles = roles;
	}
	...
	public java.util.Set<com.caihong.cms.entity.main.Content> getCollectContents() {
		return collectContents;
	}

	public void setCollectContents(
			java.util.Set<com.caihong.cms.entity.main.Content> collectContents) {
		this.collectContents = collectContents;
	}
	
	public java.util.Set<com.caihong.cms.entity.main.ContentBuy> getBuyContentSet() {
		return buyContentSet;
	}

	public void setBuyContentSet(java.util.Set<com.caihong.cms.entity.main.ContentBuy> buyContentSet) {
		this.buyContentSet = buyContentSet;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsMessage> getSendMessages() {
		return sendMessages;
	}

	public void setSendMessages(
			java.util.Set<com.caihong.cms.entity.assist.CmsMessage> sendMessages) {
		this.sendMessages = sendMessages;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsMessage> getReceivMessages() {
		return receivMessages;
	}

	public void setReceivMessages(
			java.util.Set<com.caihong.cms.entity.assist.CmsMessage> receivMessages) {
		this.receivMessages = receivMessages;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> getSendReceiverMessages() {
		return sendReceiverMessages;
	}

	public void setSendReceiverMessages(
			java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages) {
		this.sendReceiverMessages = sendReceiverMessages;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> getReceivReceiverMessages() {
		return receivReceiverMessages;
	}

	public void setReceivReceiverMessages(
			java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages) {
	...
	public java.util.Set<com.caihong.core.entity.CmsUserResume> getUserResumeSet() {
			return userResumeSet;
		}
	
	public void setUserResumeSet(
				java.util.Set<com.caihong.core.entity.CmsUserResume> userResumeSet) {
	...
	public java.util.Set<com.caihong.cms.entity.assist.CmsUserMenu> getMenus() {
		return menus;
	}

	public void setMenus(
			java.util.Set<com.caihong.cms.entity.assist.CmsUserMenu> menus) {
		this.menus = menus;
	}

	public java.util.Set<com.caihong.core.entity.CmsWorkflowEventUser> getEventUsers() {
		return eventUsers;
	}

	public void setEventUsers(
			java.util.Set<com.caihong.core.entity.CmsWorkflowEventUser> eventUsers) {
		this.eventUsers = eventUsers;
	}

	public java.util.Set<com.caihong.core.entity.CmsWorkflowRecord> getCheckRecords() {
		return checkRecords;
	}

	public void setCheckRecords(
			java.util.Set<com.caihong.core.entity.CmsWorkflowRecord> checkRecords) {
	...
	public java.util.Set<com.caihong.cms.entity.main.CmsThirdAccount> getThirdAccounts() {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.core.entity.CmsUser)) return false;
		else {
			com.caihong.core.entity.CmsUser cmsUser = (com.caihong.core.entity.CmsUser) obj;
