...
public abstract class BaseCmsSite  implements Serializable {
	...
	private com.caihong.core.entity.Ftp syncPageFtp;
	private com.caihong.core.entity.CmsConfig config;
	// one to one
	private com.caihong.core.entity.CmsSiteCompany siteCompany;
	private com.caihong.core.entity.CmsSite parent;
	...
	private java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessCount> accessCounts;
	private java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccess> accesses;
	private java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessPages> accessPages;
	private java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics;
	...
	public com.caihong.core.entity.Ftp getSyncPageFtp() {
		return syncPageFtp;
	}

	public void setSyncPageFtp(com.caihong.core.entity.Ftp syncPageFtp) {
	...
	public com.caihong.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.caihong.core.entity.CmsSiteCompany siteCompany) {
		this.siteCompany = siteCompany;
	}

	public com.caihong.core.entity.CmsSite getParent() {
		return parent;
	}

	public void setParent(com.caihong.core.entity.CmsSite parent) {
		this.parent = parent;
	}
	...
	public void setUserSites(
			java.util.Set<com.caihong.core.entity.CmsUserSite> userSites) {
	...
	public java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessCount> getAccessCounts() {
		return accessCounts;
	}

	public void setAccessCounts(
			java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessCount> accessCounts) {
		this.accessCounts = accessCounts;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccess> getAccesses() {
		return accesses;
	}

	public void setAccesses(
			java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccess> accesses) {
		this.accesses = accesses;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessPages> getAccessPages() {
		return accessPages;
	}

	public void setAccessPages(
			java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessPages> accessPages) {
		this.accessPages = accessPages;
	}

	public java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessStatistic> getAccessStatistics() {
		return accessStatistics;
	}

	public void setAccessStatistics(
			java.util.Set<com.caihong.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics) {
		this.accessStatistics = accessStatistics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.caihong.core.entity.CmsSite)) return false;
		else {
