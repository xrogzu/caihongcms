...
public abstract class BaseCmsWorkflow  implements Serializable {
	...
	// collections
	private java.util.List<com.caihong.core.entity.CmsWorkflowNode> nodes;
	private java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> events;
	 ...
	 */
	public java.util.List<com.caihong.core.entity.CmsWorkflowNode> getNodes () {
		return nodes;
	}
	 ...
	 */
	public void setNodes (java.util.List<com.caihong.core.entity.CmsWorkflowNode> nodes) {
		this.nodes = nodes;
	}
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> getEvents () {
		return events;
	}
	 ...
	 */
	public void setEvents (java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> events) {
		this.events = events;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.core.entity.CmsWorkflow)) return false;
		else {
			com.caihong.core.entity.CmsWorkflow cmsWorkflow = (com.caihong.core.entity.CmsWorkflow) obj;
