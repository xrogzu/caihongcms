...
public abstract class BaseCmsDepartment  implements Serializable {
	...
	private com.caihong.core.entity.CmsDepartment parent;

	// collections
	private java.util.Set<com.caihong.core.entity.CmsDepartment> child;
	private java.util.Set<com.caihong.cms.entity.main.Channel> channels;
	private java.util.Set<com.caihong.cms.entity.main.Channel> controlChannels;
	private java.util.Set<com.caihong.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs;
	...
	public com.caihong.core.entity.CmsDepartment getParent() {
		return parent;
	}

	public void setParent(com.caihong.core.entity.CmsDepartment parent) {
		this.parent = parent;
	}

	public java.util.Set<com.caihong.core.entity.CmsDepartment> getChild() {
		return child;
	}

	public void setChild(
			java.util.Set<com.caihong.core.entity.CmsDepartment> child) {
		this.child = child;
	}
	/**
	...
	public java.util.Set<com.caihong.cms.entity.main.Channel> getControlChannels() {
		return controlChannels;
	}

	public void setControlChannels(
			java.util.Set<com.caihong.cms.entity.main.Channel> controlChannels) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.assist.CmsGuestbookCtg> getGuestBookCtgs () {
	 ...
	 */
	public void setGuestBookCtgs (java.util.Set<com.caihong.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.core.entity.CmsDepartment)) return false;
		else {
			com.caihong.core.entity.CmsDepartment cmsDepartment = (com.caihong.core.entity.CmsDepartment) obj;
