...
import com.caihong.common.upload.FileUpload;
...
public class WeiXinSvcImpl implements WeiXinSvc {
	...
	public String getToken() {
		...
		if(site!=null){
			appid=site.getAttr().get(com.caihong.core.Constants.WEIXIN_APPKEY);
			secret=site.getAttr().get(com.caihong.core.Constants.WEIXIN_APPSECRET);
		}
