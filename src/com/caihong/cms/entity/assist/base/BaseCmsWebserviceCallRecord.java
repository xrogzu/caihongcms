...
public abstract class BaseCmsWebserviceCallRecord  implements Serializable {
	...
	public BaseCmsWebserviceCallRecord (
		...
		com.caihong.cms.entity.assist.CmsWebserviceAuth auth,
	...
	// many to one
	private com.caihong.cms.entity.assist.CmsWebserviceAuth auth;
	 ...
	 */
	public com.caihong.cms.entity.assist.CmsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.caihong.cms.entity.assist.CmsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.cms.entity.assist.CmsWebserviceCallRecord)) return false;
		else {
			com.caihong.cms.entity.assist.CmsWebserviceCallRecord cmsWebserviceCallRecord = (com.caihong.cms.entity.assist.CmsWebserviceCallRecord) obj;
