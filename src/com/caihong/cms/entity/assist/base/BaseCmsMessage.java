...
public abstract class BaseCmsMessage  implements Serializable {
	...
	// many to one
	private com.caihong.core.entity.CmsUser msgReceiverUser;
	private com.caihong.core.entity.CmsUser msgSendUser;
	private com.caihong.core.entity.CmsSite site;
	
	// collections
	private java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public com.caihong.core.entity.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (com.caihong.core.entity.CmsUser msgReceiverUser) {
	 ...
	 */
	public com.caihong.core.entity.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (com.caihong.core.entity.CmsUser msgSendUser) {
	...
	public java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<com.caihong.cms.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.caihong.cms.entity.assist.CmsMessage)) return false;
		else {
			com.caihong.cms.entity.assist.CmsMessage cmsMessage = (com.caihong.cms.entity.assist.CmsMessage) obj;
