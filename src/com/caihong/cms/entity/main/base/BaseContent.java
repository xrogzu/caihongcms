...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.caihong.cms.entity.main.ContentExt contentExt;
	private com.caihong.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.caihong.cms.entity.main.ContentType type;
	private com.caihong.core.entity.CmsSite site;
	private com.caihong.core.entity.CmsUser user;
	private com.caihong.cms.entity.main.Channel channel;
	private com.caihong.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.caihong.cms.entity.main.Channel> channels;
	private java.util.Set<com.caihong.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.caihong.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.caihong.cms.entity.main.ContentTag> tags;
	private java.util.List<com.caihong.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.caihong.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.caihong.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentDoc> contentDocSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentCharge> contentChargeSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentBuy> contentBuySet;
	private java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> eventSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentShareCheck> contentShareCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.caihong.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.caihong.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.caihong.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.caihong.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.caihong.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	private java.util.Set<com.caihong.cms.entity.main.ContentRecord> contentRecordSet;
	private java.util.List<com.caihong.cms.entity.main.ContentRewardFix> rewardFixs;
	...
	public java.util.Set<com.caihong.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.caihong.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<com.caihong.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<com.caihong.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<com.caihong.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.caihong.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
		this.scoreRecordSet = scoreRecordSet;
	}
	

	public java.util.Set<com.caihong.cms.entity.main.ContentRecord> getContentRecordSet() {
		return contentRecordSet;
	}

	public void setContentRecordSet(java.util.Set<com.caihong.cms.entity.main.ContentRecord> contentRecordSet) {
		this.contentRecordSet = contentRecordSet;
	}

	public java.util.List<com.caihong.cms.entity.main.ContentRewardFix> getRewardFixs() {
		return rewardFixs;
	}

	public void setRewardFixs(java.util.List<com.caihong.cms.entity.main.ContentRewardFix> rewardFixs) {
	 ...
	 */
	public com.caihong.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.caihong.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.caihong.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.caihong.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.caihong.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.caihong.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.caihong.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.caihong.cms.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public com.caihong.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.caihong.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.caihong.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.caihong.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.caihong.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.caihong.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.caihong.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.caihong.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.caihong.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.caihong.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.caihong.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.caihong.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.caihong.cms.entity.main.ContentCheck> contentCheckSet) {
		this.contentCheckSet = contentCheckSet;
	}

	public java.util.Set<com.caihong.cms.entity.main.ContentDoc> getContentDocSet() {
		return contentDocSet;
	}

	public void setContentDocSet(
			java.util.Set<com.caihong.cms.entity.main.ContentDoc> contentDocSet) {
		this.contentDocSet = contentDocSet;
	}
	
	public java.util.Set<com.caihong.cms.entity.main.ContentCharge> getContentChargeSet() {
		return contentChargeSet;
	}

	public void setContentChargeSet(java.util.Set<com.caihong.cms.entity.main.ContentCharge> contentChargeSet) {
		this.contentChargeSet = contentChargeSet;
	}

	public java.util.Set<com.caihong.cms.entity.main.ContentBuy> getContentBuySet() {
		return contentBuySet;
	}

	public void setContentBuySet(java.util.Set<com.caihong.cms.entity.main.ContentBuy> contentBuySet) {
		this.contentBuySet = contentBuySet;
	}

	public java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> getEventSet() {
		return eventSet;
	}

	public void setEventSet(
			java.util.Set<com.caihong.core.entity.CmsWorkflowEvent> eventSet) {
		this.eventSet = eventSet;
	}

	public java.util.Set<com.caihong.cms.entity.main.ContentShareCheck> getContentShareCheckSet() {
		return contentShareCheckSet;
	}

	public void setContentShareCheckSet(
			java.util.Set<com.caihong.cms.entity.main.ContentShareCheck> contentShareCheckSet) {
	...
	public java.util.Set<com.caihong.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.caihong.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.caihong.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.caihong.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.cms.entity.main.Content)) return false;
		else {
			com.caihong.cms.entity.main.Content content = (com.caihong.cms.entity.main.Content) obj;
