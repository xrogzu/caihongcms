...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.caihong.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.caihong.cms.entity.main.ChannelExt channelExt;
	//private com.caihong.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.caihong.core.entity.CmsSite site;
	private com.caihong.cms.entity.main.CmsModel model;
	private com.caihong.cms.entity.main.Channel parent;
	private com.caihong.core.entity.CmsWorkflow workflow;

	// collections
	private java.util.Set<com.caihong.cms.entity.main.Channel> child;
	private java.util.Set<com.caihong.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.caihong.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.caihong.core.entity.CmsUser> users;
	private java.util.Set<com.caihong.core.entity.CmsDepartment> departments;
	private java.util.Set<com.caihong.core.entity.CmsDepartment> controlDeparts;
	private java.util.Set<com.caihong.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.Set<com.caihong.cms.entity.main.ChannelCount> channelCountSet;
	private java.util.List<com.caihong.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.caihong.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.caihong.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	/*
	public com.caihong.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.caihong.cms.entity.main.ChannelCount channelCount) {
	...
	*/
	 ...
	 */
	public com.caihong.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.caihong.cms.entity.main.Channel parent) {
		this.parent = parent;
	}

	public com.caihong.core.entity.CmsWorkflow getWorkflow() {
		return workflow;
	}

	public void setWorkflow(com.caihong.core.entity.CmsWorkflow workflow) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.caihong.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.caihong.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.caihong.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.caihong.core.entity.CmsUser> users) {
		this.users = users;
	}
	


	public java.util.Set<com.caihong.core.entity.CmsDepartment> getDepartments() {
		return departments;
	}

	public void setDepartments(
			java.util.Set<com.caihong.core.entity.CmsDepartment> departments) {
		this.departments = departments;
	}

	public java.util.Set<com.caihong.core.entity.CmsDepartment> getControlDeparts() {
		return controlDeparts;
	}

	public void setControlDeparts(
			java.util.Set<com.caihong.core.entity.CmsDepartment> controlDeparts) {
	 ...
	 */
	public java.util.Set<com.caihong.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.caihong.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}


	public java.util.Set<com.caihong.cms.entity.main.ChannelCount> getChannelCountSet() {
		return channelCountSet;
	}

	public void setChannelCountSet(java.util.Set<com.caihong.cms.entity.main.ChannelCount> channelCountSet) {
		this.channelCountSet = channelCountSet;
	}


	public java.util.List<com.caihong.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.caihong.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.cms.entity.main.Channel)) return false;
		else {
			com.caihong.cms.entity.main.Channel channel = (com.caihong.cms.entity.main.Channel) obj;
