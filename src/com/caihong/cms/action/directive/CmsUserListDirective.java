 ...
 * 专题列表标签
 */
public class CmsUserListDirective implements TemplateDirectiveModel {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "cmsuser_list";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<CmsUser> list=cmsUserMng.getListForTag(null, null, null, null, null);
