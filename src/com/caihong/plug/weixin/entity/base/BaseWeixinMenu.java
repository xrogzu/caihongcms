package com.caihong.plug.weixin.entity.base;
...
public abstract class BaseWeixinMenu  implements Serializable {
	...
	// many to one
	private com.caihong.plug.weixin.entity.WeixinMenu parent;
	private com.caihong.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.caihong.plug.weixin.entity.WeixinMenu> child;
	 ...
	 */
	public com.caihong.plug.weixin.entity.WeixinMenu getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.caihong.plug.weixin.entity.WeixinMenu parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.caihong.plug.weixin.entity.WeixinMenu> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.caihong.plug.weixin.entity.WeixinMenu> child) {
		this.child = child;
	}

	public void addTochild (com.caihong.plug.weixin.entity.WeixinMenu weixinMenu) {
		if (null == getChild()) setChild(new java.util.TreeSet<com.caihong.plug.weixin.entity.WeixinMenu>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.plug.weixin.entity.WeixinMenu)) return false;
		else {
			com.caihong.plug.weixin.entity.WeixinMenu weixinMenu = (com.caihong.plug.weixin.entity.WeixinMenu) obj;
