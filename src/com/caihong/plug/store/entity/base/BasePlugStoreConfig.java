package com.caihong.plug.store.entity.base;
...
public abstract class BasePlugStoreConfig  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.caihong.plug.store.entity.PlugStoreConfig)) return false;
		else {
			com.caihong.plug.store.entity.PlugStoreConfig plugStoreConfig = (com.caihong.plug.store.entity.PlugStoreConfig) obj;
